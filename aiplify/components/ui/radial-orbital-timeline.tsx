...
export default function RadialOrbitalTimeline({
  ...
  const getStatusStyles = (status: TimelineItem["status"]): string => {
    switch (status) {
      ...
      case "in-progress":
        return "border-white bg-blue-400 text-black";
      case "pending":
  ...
  return (
    <div
      className="flex min-h-[680px] w-full flex-col items-center justify-center overflow-hidden bg-black"
      ref={containerRef}
      onClick={handleContainerClick}
    >
      <div className="relative flex h-full min-h-[680px] w-full max-w-4xl items-center justify-center">
        <div
        ...
        >
          <div className="absolute z-10 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-white via-blue-100 to-cyan-200">
            ...
            />
            <div className="h-8 w-8 rounded-full bg-black/80 backdrop-blur-md" />
          </div>
            ...
            return (
              ...
              >
                ...
                <div
                  ...
                  ${
                    isExpanded
                      ? "scale-150 border-white shadow-lg shadow-white/30"
                      : isRelated
                ...
                <div
                  className={`
                  absolute top-12 whitespace-nowrap text-xs font-semibold tracking-wide
                    ...
                    <CardContent className="text-xs text-white/80">
                      ...
                      <div className="mt-4 border-t border-white/10 pt-3">
                        ...
                        <div className="h-1 w-full overflow-hidden rounded-full bg-white/10">
                          <div
                            className="h-full bg-gradient-to-r from-blue-400 to-cyan-200"
                      ...
                      {item.relatedIds.length > 0 && (
                        <div className="mt-4 border-t border-white/10 pt-3">
                          <div className="mb-2 flex items-center">
                            ...
                            <h4 className="text-xs font-medium uppercase tracking-wide text-white/70">
                              Connected Nodes
                            </h4>
                          </div>
